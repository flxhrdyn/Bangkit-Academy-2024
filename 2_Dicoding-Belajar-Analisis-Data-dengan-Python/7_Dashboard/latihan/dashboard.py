...
# Load berkas all_data.csv sebagai sebuah DataFrame menggunakan kode berikut.
...
# Pada bagian awal, kita perlu menambahkan header pada dashboard tersebut
st.header('Dicoding Collection Dashboard :sparkles:')

# menampilkan informasi total order dan revenue dalam bentuk metric() yang ditampilkan menggunakan layout columns().
# Di lain sisi, informasi tentang jumlah order harian ditampilkan dalam bentuk visualisasi data seperti kode berikut.
...
# Informasi berikutnya yang ingin kita tampilkan pada dashboard tersebut ialah terkait demografi pelanggan yang kita miliki.
...
# Selain itu kita juga akan menampilkan hasil visualisasi data dari latihan sebelumnya.
