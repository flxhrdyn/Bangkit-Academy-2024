...
function getModel() {
    ...
    model.compile({loss: "categoricalCrossentropy", optimizer: tf.train.adam(), metrics: ["accuracy"]})// YOUR CODE HERE;
...
async function train(model, data) {
    ...
    const container = {name: "Model Training", styles:{height: "720px"} };// YOUR CODE HERE   
